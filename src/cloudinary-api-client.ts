...
export const fetchFromCloudinary = async (
  ...
  // } catch (err) {
  //   console.error('Error communicating with the Cloudinary Search API: ', err);
  //   const src = `https://res.cloudinary.com/${cloudName}/image/upload/v${version}/${data.publicId}.${data.format}`;
  //   return url;
  // }
};
